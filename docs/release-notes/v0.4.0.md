...
- **上游升级**：基于 DeepSeek Harness **0.1.0-rc.8**（GitHub commit [`141eb6fe`](https://github.com/deepseek-ai/deepseek-harness/tree/141eb6fef83422698aef7a981029e843e8161534)）构建
...
- **Upstream**: built on DeepSeek Harness **0.1.0-rc.8** ([`141eb6fe`](https://github.com/deepseek-ai/deepseek-harness/tree/141eb6fef83422698aef7a981029e843e8161534))
...
- External subagent backends (claude-code / codex / acp / dsh-sdk) ship with the app, but their CLIs (`claude` / `codex`) must be installed separately and added to PATH; the ~260MB Claude Agent SDK native binaries are no longer bundled (dsh resolves `claude` from PATH at runtime)
