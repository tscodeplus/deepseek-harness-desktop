...
const MANIFEST_TEXT = JSON.stringify({
  ...
  platforms: {
    'win32-x64': {
      ...
      url: 'https://github.com/tscodeplus/deepseek-harness-desktop/releases/download/engine/dsh-engine-win32-x64-99f6f02fecdb.tar.gz',
    ...
    'darwin-arm64': {
      ...
      url: 'https://github.com/tscodeplus/deepseek-harness-desktop/releases/download/engine/dsh-engine-darwin-arm64-99f6f02fecdb.tar.gz',
      sha512: 'c2hhNTEyLWZha2U=',
      size: 12345678,
    },
  },
