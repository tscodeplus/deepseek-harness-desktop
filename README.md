...
- **Zero setup** — bundled Node.js runtime + pre-built dsh closure; no manual Node.js install or configuration
...
- **Auto-update (Windows)** — installer metadata (`latest.yml`) generated by CI, checked in-app against GitHub Releases
